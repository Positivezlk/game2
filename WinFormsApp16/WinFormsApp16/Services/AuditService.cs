...
public sealed class AuditService(CurrentUser? user)
{
    public void Log(string action, string? entityType = null, int? entityId = null, string? description = null) =>
        Write(user, action, entityType, entityId, description);

    public static void Write(CurrentUser? user, string action, string? entityType = null, int? entityId = null, string? description = null)
    {
