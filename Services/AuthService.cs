...
public sealed class AuthService
{
    public User? Login(string login, string password)
    {
        ...
        var user = new User { Id = r.GetInt32(0), Login = r.GetString(1), Role = r.GetString(3), EmployeeId = r.IsDBNull(4) ? null : r.GetInt32(4), IsActive = r.GetInt32(5) == 1 };
    ...
    public static bool CanEdit(User user) => user.Role is "administrator" or "specialist";
    public static bool CanAudit(User user) => user.Role == "administrator";
}
